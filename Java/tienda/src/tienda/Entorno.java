...
8.   void MuestraConfiguracion (int i)
         {
          El fin del método será mostrar la configuración mediante un índice que le
          pasaremos; para ello crearemos un objeto de clase Venta, que rellenaremos
          con los datos almacenados en la posición i del Vector clientes (ver varialbes
          de clase) utilizado para ello un CAST.
         }

9.   Venta GuardaEnClase()
         {
...
// Método privado que muestra la configuración según un índice pasado como parametro
   private void MuestraConfiguracion(int i){
    ...
    jTextFieldnombrecliente.setText(comprador.getNombre());
    jComboBoxlocalidad.setSelectedIndex(comprador.getLocalidad());
    ActivaRadio(jRadioButtonprocesador1,jRadioButtonprocesador2,jRadioButtonprocesador3,jRadioButtonprocesador4,comprador.getProcesador());
    ActivaRadio(jRadioButtonmemoria1,jRadioButtonmemoria2,jRadioButtonmemoria3,jRadioButtonmemoria4,comprador.getMemoria());
    ActivaRadio(jRadioButtonmonitor1,jRadioButtonmonitor2,jRadioButtonmonitor3,jRadioButtonmonitor4,comprador.getMonitor());
    ActivaRadio(jRadioButtonhd1,jRadioButtonhd2,jRadioButtonhd3,jRadioButtonhd4,comprador.getHD());
    ActivaOpciones(jCheckBoxopcion1, jCheckBoxopcion2, jCheckBoxopcion3, jCheckBoxopcion4, comprador.getOpcion1(), comprador.getOpcion2(), comprador.getOpcion3(), comprador.getOpcion4() );
...
// Botón Salir
  void jButtonsalir_actionPerformed(ActionEvent e) {
    ...
    int aseguradora = MensajeSiNo("¡ Atención !", "Ésta operación no tiene vuelta atrás\n\n¿Desea Salir?");
  ...
  // Cuenado la lista tenga el foco
