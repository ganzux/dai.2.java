...
////////////////////////////////////////////////////////////////////////////////
    ...
    jMenuItemPedidos.addActionListener(new VentanaPrincipal_jMenuItemPedidos_actionAdapter(this));
    jMenuBarMenu.add(jMenuMantenimiento);

    jMenuBarMenu.add(jMenuAlmacen);
...
// MENÚ ACERCA DE
  ...
  void jMenuItemPedidos_actionPerformed(ActionEvent e) {
    // Creamos una ventana Formulario
    VentanaPedidos pedido = new VentanaPedidos(this);
    // Ponemos esta ventana sin que se pueda tocar
    setEnabled(false);
    // Centramos la nueva Ventana, para lo cula llamaremos al método Centrar
    Centrar(pedido);
...
class VentanaPrincipal_jMenuItemPedidos_actionAdapter implements java.awt.event.ActionListener {
  VentanaPrincipal adaptee;

  VentanaPrincipal_jMenuItemPedidos_actionAdapter(VentanaPrincipal adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
    adaptee.jMenuItemPedidos_actionPerformed(e);
  }
}
