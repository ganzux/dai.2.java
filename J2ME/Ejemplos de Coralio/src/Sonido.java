...
public class Sonido extends MIDlet implements CommandListener {
    ...
    private Command exit,wav, nota, secuencia,mp3,mid,video,lista,archivo;
    ...
    public Form creaFormularioVacio(){
        ...
        archivo = new Command("Archivo", Command.EXIT, 2);
    ...
    public void playArchivo() {
        try {
            ...
            //InputStream sonido = getClass().getResourceAsStream((Connection)Connector.open("file:///E:/prueba.wav"));
            
            /* Creamos un objeto de tipo Player, al cual le pasamos el sonido y su tipo*/
            //Player player = Manager.createPlayer(sonido,"audio/x-wav");
        ...
        display.setCurrent(alert);      
            ...
            Alert alr = new Alert("Error", "No se pudo reproducir el archivo de la tarjeta.",null, AlertType.ERROR);
            alr.setTimeout(Alert.FOREVER);
            display.setCurrent(alr, formulario);
        }
    }
